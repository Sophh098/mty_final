...
public final class Constants {
  ...
  public static final class IntakePivotConstants {
        ...
        // Roller Motor ID (CAN ID from REV Hardware Client)
        public static final int PIVOT_LEFT_MOTOR_ID = 19;
        public static final int PIVOT_RIGHT_MOTOR_ID =18;

        // Pivot settings
        public static final boolean kPivotLeftInverted = false;
        public static final boolean kPivotRightInverted = true;
        public static final IdleMode kPivotLeftIdleMode = IdleMode.kCoast;
        public static final IdleMode kPivotRightIdleMode =IdleMode.kCoast;

        //Current limit (amps)
        public static final int kPivotCurrentLimit = 20;

        public static final double kPivotUpSpeed = 0.1;
